...
export const LANGUAGES = ['Tamil', 'English', 'Hindi', 'Malayalam', 'Telugu'] as const;
...
export const ICONS = {
  ...
  FileAudio: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 22h.5a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><circle cx="9" cy="18" r="4"/><path d="M13 18V9"/></svg>
  )
};
